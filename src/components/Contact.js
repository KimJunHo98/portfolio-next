                ...
                <div className="inner">
                    <div className="contact">
                        ...
                        <ul className="contact_me">
                            <li className="my_address" ref={(el) => (contactRef.current[4] = el)}><span>gmail:</span> dydgnscc6845@gmail.com</li>
                            <li className="my_address" ref={(el) => (contactRef.current[5] = el)}><span>naver:</span> dydgnscc6845@naver.com</li>
                            <li className="my_instagram" ref={(el) => (contactRef.current[6] = el)}><span>kakao:</span> wungh12</li>
                            <li className="my_number" ref={(el) => (contactRef.current[7] = el)}><span>phone:</span> 010-5672-4735</li>
                        </ul>
                    </div>
                </div>
            </div>

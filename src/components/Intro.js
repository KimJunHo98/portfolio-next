...
const Intro = () => {
    ...
    const textArr2 = useMemo(() => "Scroll Down Scroll Down Scroll Down Scroll Down".split(" "), []);
    const textArr3 = useMemo(() => "web publisher & frontend developer & web publisher & frontend developer &".split(" "), []);
